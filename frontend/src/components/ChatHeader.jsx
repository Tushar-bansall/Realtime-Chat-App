...
const ChatHeader = () => {
  ...
  return (
    <div className='p-1.5 md:p-2.5 border-b border-base-300'>
        <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3 md:gap-6 md:ml-5'>
                ...
                <div>
                    <h3 className='font-light md:font-medium'>{selectedUser.fullName}</h3>
