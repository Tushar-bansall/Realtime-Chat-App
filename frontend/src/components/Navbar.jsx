  ...
  return (
    <div className="navbar bg-base-100 bg-transparent">
      {currentURL === '/settings' ? (
        ...
        <Link to="/settings" className="btn btn-xs sm:btn-sm md:btn-md sm:gap-2 transition-colors">
          <svg
            fill="#ffffff"
            className="h-4 w-4 md:h-5 md:w-5"
            version="1.1"
  ...
  return (
      <div className="navbar bg-base-100">
        <div className="flex-1">
          <Link to="/" className="btn btn-ghost btn-xs sm:btn-sm md:btn-md text-sm sm:text-base md:text-xl">MT😉Chat</Link>
        </div>
        {authUser && 
        ...
        <div className="flex-none gap-2">
          ...
          <form class="flex items-center max-w-[calc(60vw)] ">   
              <div class="relative">
                  <input type="text" id="voice-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block sm:ps-10 p-0.5 sm:p-1.5 md:p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search " required />
                  <button type="button" class="absolute inset-y-0 end-0 flex items-center sm:pe-3">
            ...
            {authUser ?
              <div className="dropdown dropdown-end">
                ...
                <div tabIndex={0} role="button" className="btn btn-xs sm:btn-sm md:btn-md btn-circle avatar btn-ghost">
